...
[senal_20dB, fs]=wavread('./dataset/chirp/senal_20dB.wav');
senal_30dB=wavread('./dataset/chirp/senal_30dB.wav');
senal_40dB=wavread('./dataset/chirp/senal_40dB.wav');
senal_50dB=wavread('./dataset/chirp/senal_50dB.wav');
senal_60dB=wavread('./dataset/chirp/senal_60dB.wav');

senal_20dB_mp3=mp3read('./dataset/chirp/senal_20dB.mp3');
senal_30dB_mp3=mp3read('./dataset/chirp/senal_30dB.mp3');
senal_40dB_mp3=mp3read('./dataset/chirp/senal_40dB.mp3');
senal_50dB_mp3=mp3read('./dataset/chirp/senal_50dB.mp3');
senal_60dB_mp3=mp3read('./dataset/chirp/senal_60dB.mp3');
...
[S_30dB,F,T,P_30dB] = spectrogram(senal_30dB,hanning(nfft),n_overlap,nfft,fs,'yaxis');
[S_40dB,F,T,P_40dB] = spectrogram(senal_40dB,hanning(nfft),n_overlap,nfft,fs,'yaxis');
[S_50dB,F,T,P_50dB] = spectrogram(senal_50dB,hanning(nfft),n_overlap,nfft,fs,'yaxis');
[S_60dB,F,T,P_60dB] = spectrogram(senal_60dB,hanning(nfft),n_overlap,nfft,fs,'yaxis');
...
[S_30dB_mp3,F,T,P_30dB_mp3] = spectrogram(senal_30dB_mp3,hanning(nfft),n_overlap,nfft,fs,'yaxis');
[S_40dB_mp3,F,T,P_40dB_mp3] = spectrogram(senal_40dB_mp3,hanning(nfft),n_overlap,nfft,fs,'yaxis');
[S_50dB_mp3,F,T,P_50dB_mp3] = spectrogram(senal_50dB_mp3,hanning(nfft),n_overlap,nfft,fs,'yaxis');
[S_60dB_mp3,F,T,P_60dB_mp3] = spectrogram(senal_60dB_mp3,hanning(nfft),n_overlap,nfft,fs,'yaxis');
...
title('Espectrograma .wav 50dB'), xlabel('Tiempo(s)'), ylabel('Frecuencia(Hz)'),
axis([0 max(T) 40 300]);
subplot(2,1,2), imagesc(T,F,10*log10(P_50dB_mp3)), axis xy,
title('Espectrograma .mp3 50dB'), xlabel('Tiempo(s)'), ylabel('Frecuencia(Hz)'),
axis([0 max(T) 40 300]);

figure('Name','Espectrograma (dB)'),
subplot(2,1,1), imagesc(T,F,10*log10(P_60dB)), axis xy,
title('Espectrograma .wav 60dB'), xlabel('Tiempo(s)'), ylabel('Frecuencia(Hz)'),
axis([0 max(T) 40 300]);
subplot(2,1,2), imagesc(T,F,10*log10(P_60dB_mp3)), axis xy,
title('Espectrograma .mp3 60dB'), xlabel('Tiempo(s)'), ylabel('Frecuencia(Hz)'),
axis([0 max(T) 40 300]);